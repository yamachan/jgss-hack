...
実は RPG Maker VX Ace の時代にハクスラっぽい拡張は試したことがあって、[2014/06 My 1st study](/yamachan/rgss3-hack/blob/master/memo/201406-1st-study.md) や、英語だけど [What is ktr1 tool](/yamachan/rgss3-hack/blob/master/memo/201605-ktr1-tool_01.md) あたりにメモが残っています。
...
VX Ace の [The Code for Item colors](/yamachan/rgss3-hack/blob/master/memo/201605-ktr1-tool_01.md#the-code-for-item-colors) では Window_Base クラスの draw_item_name メソッドを置き換えていました。MV では名前ルールが異なりますので、drawItemName メソッドが該当します。
...
VX Ace の [Uncountable items](/yamachan/rgss3-hack/blob/master/memo/201605-ktr1-tool_01.md#uncountable-items) では Window_ItemList クラスの draw_item_number メソッドを置き換えていました。MV では名前ルールが異なりますので、drawItemNumber メソッドが該当します。
