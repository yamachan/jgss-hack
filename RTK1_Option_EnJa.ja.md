...
このようにノート欄に &lt;ja日本語テキスト&gt; や &lt;ja日本語テキスト&gt; を記載することにより、各ゲーム要素のテキストの英語/日本語切り替えが可能になります。
...
通常通りこれらのイベントコマンドを利用すると、英語・日本語どちらも同じ値に変更してしまいます。 この動作は意図的なもので、既存のゲームにプラグインを導入しても影響が少なくなる効果があります。
